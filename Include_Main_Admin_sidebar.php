...
<html>
    ...
    <body>
        ...
        <div class="w3-sidebar w3-bar-block w3-animate-left" style="display:none;z-index:5; width:300px;" id="mySidebar">
            ...
            <a href="Main_Admin.php" class="w3-bar-item w3-button w3-border w3-hover-teal glyphicon" style="font-size:20px; padding: 15px;">Main</a>
            <a href="Add_Admin.php" class="w3-bar-item w3-button w3-border w3-hover-teal glyphicon" style="font-size:17px; padding: 15px;"> Add Admin</a>
            <a href="Edit_Admin.php" class="w3-bar-item w3-button w3-border w3-hover-teal glyphicon" style="font-size:17px; padding: 15px;">Edit_Admin</a>
            <a href="Delete_Admin.php" class="w3-bar-item w3-button w3-border w3-hover-teal glyphicon" style="font-size:17px; padding: 15px;">Delete Admin</a>
            <a href="Delete_Device.php" class="w3-bar-item w3-button w3-border w3-hover-teal glyphicon" style="font-size:17px; padding: 15px;"> Delete Device</a>
